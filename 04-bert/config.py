...
class Config(object):
    def __init__(self):
        ...
        # 模型训练保存路径
        self.model_save_path = self.root_path + "04-bert/save_models/bert_classifier_model.pt"  # 模型训练结果保存路径
        ...
        self.bert_model = BertModel.from_pretrained(self.bert_path, trust_remote_code=True) # 加载预训练BERT模型
        ...
        # 5. 量化模型存放地址
        self.bert_model_quantization_model_path = self.root_path + "04-bert/save_models/bert_classifier_quantization_model.pt"  # 模型训练结果保存路径
