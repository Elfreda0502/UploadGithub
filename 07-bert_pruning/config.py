...
class Config(object):
    def __init__(self):
        ...
        # 2. 路径配置.
        # 根目录
        self.root_path = 'D:/workspace/ai_04_work_gz/TMF_Project/'
        # 原始数据路径
        ...
        # 模型训练保存路径
        self.model_save_path = self.root_path + "07-bert_pruning/save_models/bert_classifier_model.pt"  # 模型训练结果保存路径
        ...
        # 5. 剪枝模型存放地址
        self.bert_model_pruning_model_path = self.root_path + "07-bert_pruning/save_models/bert_classifier_pruning_model.pt"  # 模型训练结果保存路径
